...
Shader "BreathingScenarioRoot"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( lerpResult12 * tex2D( _Emission, uv_Emission ) * (0.0 + (timeBreathing - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) ).rgb;
...
/*ASEBEGIN
Version=18912
0;66;1512;821;2229.617;467.5497;2.145853;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-861.6154,280.0643;Inherit;False;Global;timeBreathing;timeBreathing;7;0;Create;True;0;0;0;False;0;False;0.1;-0.3088065;0.1;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C605B2F58BF2D521C0E5AD7446E5295D74FAF678