...
Shader "BreathingScenario"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( _EmissionColor * tex2D( _Emission, uv_Emission ) * (0.0 + (_SinTime.w - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) ).rgb;
...
/*ASEBEGIN
Version=13501
183;31;1666;974;1016;354;1;True;False
...
ASEEND*/
//CHKSM=E48B7732E5B2798C6C4BD5E26D98C6884B7A8582