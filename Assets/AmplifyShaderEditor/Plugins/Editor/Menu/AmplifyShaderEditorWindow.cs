						...
						for( int instructionIdx = 3; instructionIdx < instructions.Length - 1; instructionIdx++ )
						{
							...
							switch( parameters[ 0 ] )
							{
								case IOUtils.NodeParam:
								{
									...
									System.Type type = System.Type.GetType( typeStr );//System.Type.GetType( IOUtils.NodeTypeReplacer.ContainsKey( typeStr ) ? IOUtils.NodeTypeReplacer[ typeStr ] : typeStr );
									if( type != null )
									{
										System.Type oldType = type;
