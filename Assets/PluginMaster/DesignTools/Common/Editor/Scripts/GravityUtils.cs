...
namespace PluginMaster
{
    ...
    public static class GravityUtils
    {
        ...
        public static void SimulateGravity(GameObject[] selection, SimulateGravityData data, bool recordAction)
        {
            ...
            for (int i = 0; i < selection.Length; ++i)
            {
                ...
                foreach (var meshFilter in meshFilters)
                {
                    ...
                    AddCollider(meshFilter.gameObject, mesh);
                }
                ...
                foreach (var renderer in skinnedMeshRenderers)
                {
                    ...
                    AddCollider(renderer.gameObject, mesh);
                }
            ...
            for (int i = 0; i < selection.Length; ++i)
            {
                ...
                if (recordAction) UnityEditor.Undo.RecordObject(selection[i].transform, "Simulate Gravity");
        ...
        private static void Animate(List<AnimData> data)
        {
            _stop = false;
            _isPlaying = true;
            Animate(data, 0);
        ...
        private async static void Animate(List<AnimData> data, int frame)
        {
           var isPlaying = false;
            if (_stop) return;
